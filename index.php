...
<a href='#' onclick="window.location = 'autoxResults.php?raceNumber='+document.getElementById('raceNumber').value + '&conePenalty=<?php echo $clubConePenalty[$latestEventGroup] ?>&sourceURL=<?php echo $clubLiveURL[$latestEventGroup] ?>'">Current Data</a><br> 
...
for ($i = 1; $i <= $totalGroups; $i++) {
	...
	<tr><td>
	<?php echo $clubName[$i]?> 
	(<a href='#' onclick="window.location = 'autoxResults.php?raceNumber='+document.getElementById('raceNumber').value + '&conePenalty=<?php echo $clubConePenalty[$i] ?>&sourceURL=<?php echo $clubLiveURL[$i] ?>'">formatted data</a>) - 
